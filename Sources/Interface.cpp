...
AVSValue __cdecl Create_MVRecalculate(AVSValue args, void*, IScriptEnvironment* env)
{
  ...
  return new MVRecalculate(
    ...
    args[31].AsFloat(-1.0f), // AMthVSMang - threshold of angular Vectors Stability Metric
    env
  );
}
